...
module.exports = { //dazi 
	...
	USER_CHECK_FORM: {
		...
		mobile: 'formMobile|must|mobile|name=QQ',
	...
	ACTIVITY_JOIN_FIELDS: [
		{ mark: 'name', type: 'text', title: 'VRChat ID', must: true, max: 30 },
		{ mark: 'phone', type: 'mobile', title: 'QQ', must: true, edit: false, ext: { hidden: true } }
	],
