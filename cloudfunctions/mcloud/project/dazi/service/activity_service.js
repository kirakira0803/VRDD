...
class ActivityService extends BaseProjectService {
	...
	async getActivityList({
		...
		let fields = 'ACTIVITY_TYPE,ACTIVITY_STOP,ACTIVITY_JOIN_CNT,ACTIVITY_OBJ,ACTIVITY_VIEW_CNT,ACTIVITY_TITLE,ACTIVITY_MAX_CNT,ACTIVITY_START_DAY,ACTIVITY_START,ACTIVITY_END,ACTIVITY_ORDER,ACTIVITY_STATUS,ACTIVITY_CATE_NAME,ACTIVITY_OBJ,user.USER_NAME,user.USER_PIC,user.USER_OBJ.sex';
